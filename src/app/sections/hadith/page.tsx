...
// Dynamically import the HadithSection to avoid SSR issues
...
export default function HadithPage() {
  ...
  useEffect(() => {
    ...
    const title = t("hadith.title") !== "hadith.title" ? t("hadith.title") : "الأحاديث";
    const description = t("hadith.subtitle") !== "hadith.subtitle" ? t("hadith.subtitle") : "أحاديث نبوية";
