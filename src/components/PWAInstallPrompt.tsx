...
export default function PWAInstallPrompt() {
  ...
  return (
    <aside
      className="safe-fixed-bottom-left fixed z-50 max-w-[min(20rem,calc(100vw-6.75rem-env(safe-area-inset-left,0px)-env(safe-area-inset-right,0px)))] bg-white/95 p-3 text-gray-900 shadow-lg dark:bg-gray-800/95 dark:text-white rounded-full border border-islamic-gold/20 pwa-install-enter"
      role="dialog"
